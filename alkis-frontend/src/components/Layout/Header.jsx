        ...
        <>
            ...
            >
                <div className="space-y-4 text-gray-300">
                    ...
                    <p>
                        In the middle, the interactive map is the default tab. Here, you can AX_Plore Berlin at will, but note that as of now, AX_Ploration only includes information on the city districts Mitte, Pankow and Friedrichshain-Kreuzberg. After a query has been answered, the matched buildings are displayed on the map, and by clicking on them, further information is displayed in a pop-up. After switching to the statistics tab, the total number of buildings is displayed. Here, you can also find the mean, min. and max. area and number of floors, and the lowest and highest house numbers.
                    </p>
                    <p>
                        The right side shows the results of a query. At the top, you can select a sorting method for the results listed below. This includes: Sort by area, sort by name and sort by floors. These sorting types allow you to more easily find what you are searching for. You can also select all buildings or reject your current selection, as well as export the building information of all selected buildings as a GeoJSON. Then, the cypher query is displayed to show you exactly how the chatbot interpreted your question - this is helpful if you are not sure whether your question was interpreted correctly. Of course, it would be best if you knew a bit of Cypher to make sense of the query. Below the cypher query, all buildings that are matching your question and that were returned by the chatbot are listed with detailed information. You can explore these in detail here or in the map, whichever way you prefer.
                    </p>
                    <p>
